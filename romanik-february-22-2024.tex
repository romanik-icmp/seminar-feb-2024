	...
	\begin{spacing}{1}
		...
		%	\column{0.9\textwidth}
			\begin{figure}[htbp]
				...
				\parbox{0.5\textwidth}{\caption*{\label{m2_vs_k} Fig. Cumulant $\mathfrak{m}_2$ as a function of $k\sigma$ at different values of packing fraction $\eta$. 1 - $\eta = 0.05$, 2 - $\eta=0.1$, 3 - $\eta = 0.15$, and 4 - $\eta=0.2$.
				}} \hfill
				\parbox{0.45\textwidth}{\caption*{\label{m2_vs_eta} Fig. Cumulant $\mathfrak{m}_2$ as a function of packing fraction $\eta$ at $\vb k = 0$
				}}
			\end{figure}
...
\begin{frame}
	...
	\begin{spacing}{1}
		...
		\begin{figure}[htbp]
			...
			\parbox{0.5\textwidth}{\caption*{\label{m4_vs_k} Fig. Cumulant $\mathfrak{m}_4$ as a function of $k\sigma$ at different values of packing fraction $\eta$. 1 - $\eta = 0.05$, 2 - $\eta=0.1$, 3 - $\eta = 0.15$, and 4 - $\eta=0.2$.
			}} \hfill
			\parbox{0.45\textwidth}{\caption*{\label{m4_vs_eta} Fig. Cumulant $\mathfrak{m}_4$ as a function of packing fraction $\eta$ at $\vb k = 0$
			}}
		\end{figure}
...
\begin{frame}
	...
	\begin{spacing}{1}
		...
		\begin{equation*}
			 ...
			 \left(
			 	1 + \frac{\mathfrak{m}_2 \mathfrak{m}_3}{\mathfrak{m}_4} + \frac{\mathfrak{m}_3^3}{3\mathfrak{m}_4^2}
			 \right)
		\end{equation*}
...
\begin{frame}
	...
	\begin{spacing}{1}
		...
		\begin{columns}
			...
			-- Conditions for critical point to exist
			\begin{equation*}
				\mu^* = 0
			\end{equation*}
...
\begin{frame}
	...
	\begin{spacing}{1}
		...
		\begin{equation*}
			\eta_c = 0.13044 \quad (\rho_c = 0.24913)
		\end{equation*}
		\begin{equation*}
...
\begin{frame}
	...
	\begin{itemize}
		\item Functional form for the grand partition function is obtained with all coefficients explicitly known as functions of density, temperature and chemical potential
