...
\begin{frame}
	...
	\begin{spacing}{1}
		...
		\begin{figure}[htbp]
			...
			\includegraphics[width=0.45\textwidth,angle=0]{a2_as_function_of_eta} \\
			\parbox{0.5\textwidth}{\caption*{}} \hfill
...
\begin{frame}
	...
	\begin{spacing}{1}
		...
		\begin{columns}
			...
			\begin{equation*}
				\left(\frac{\mathfrak{m}_2 \mathfrak{m}_3}{\abs{\mathfrak{m}_4}} + \frac{\mathfrak{m}_3^3}{3\mathfrak{m}_4^2}\right) = 0.
			\end{equation*}
